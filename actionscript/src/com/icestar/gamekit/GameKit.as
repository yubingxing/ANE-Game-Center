package com.icestar.gamekit
{
	...
	final public class GameKit {
		public static const EXTENSION_ID:String = "com.icestar.GameKit";
		...
		public static function joinServer(peerId:String):void {
			extensionContext.call( NativeMethods.joinServer, peerId);
		}
		
		public static function acceptPeer(peerId:String):void {
			extensionContext.call( NativeMethods.acceptPeer, peerId);
		}
		
		public static function denyPeer(peerId:String):void {
			extensionContext.call( NativeMethods.denyPeer, peerId);
		}
		/**
